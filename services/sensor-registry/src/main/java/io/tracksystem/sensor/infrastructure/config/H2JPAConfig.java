package io.tracksystem.sensor.infrastructure.config;
...
@EnableJpaRepositories(basePackages = {
        "io.tracksystem.sensor.infrastructure"
...
public class H2JPAConfig {
    ...
    // Clase de configuracion para crear e insertar datos en una tabla en H2,
    // mediante scripts.
    @Configuration
